...
datamodule = Folder(
    name="candle",
    root=("/home/jonathanyeh/anomalib/datasets/visa_torch/onecls/candle"), #/home/jonathanyeh/anomalib/datasets/LGP_new/  /home/jonathanyeh/anomalib/datasets
    normal_dir="train/good",  # new_mini Subfolder containing normal images   CUDA_VISIBLE_DEVICES=1 PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
    abnormal_dir="test/bad",  # Subfolder containing anomalous images
