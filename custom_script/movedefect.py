...
# Paths
heatmap_folder = Path(r"C:\Users\1003380\anomalib\total_defect")
raw_folder = Path(r"C:\Users\1003380\anomalib\datasets\LGP\mega")
destination_folder = Path(r"C:\Users\1003380\anomalib\datasets\LGP\train\isolated")
...
for raw_file in raw_folder.iterdir():
    if raw_file.is_file() and raw_file.name in heatmap_files:
        ...
        print(f"Copyed: {raw_file.name}")
        count += 1
print("Total files num: ", count)
